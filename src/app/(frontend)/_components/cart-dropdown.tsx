        ...
        >
            <Popover className="relative h-full">
                <PopoverButton className="h-full">
                    <Link
                        className="hover:text-ui-fg-base relative flex rounded-full p-2 transition-colors hover:bg-blue-50"
                ...
                >
                    <PopoverPanel
                        className="hidden small:block absolute top-[calc(100%+1px)] left-0 bg-white border-x border-b border-gray-200 w-[420px] text-ui-fg-base"
